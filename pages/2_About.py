...
st.markdown(
    """
    If there are issues with this application, please make a PR on the [GitHub repo](https://github.com/hunterschep/college-earnings)
...
with col1:
    ...
    st.markdown("[GitHub Repository](https://github.com/hunterschep/college-earnings)")
